...
export const reorderWork   = (items)      => api.put('/work/reorder', { items })
...
export const addCategory = (category) => api.post('/admin/categories', { category });
export const deleteCategory = (name) => api.delete(`/admin/categories/${name}`);

export const fetchYouTubeMetadata = (url) => api.get('/youtube/metadata', { params: { url } })
