        ...
        <div className="about-inner">
          ...
          <div className="about-left">
            ...
            <p className="about-text reveal">
              {bio1 ||
                "I'm KIR4 — a thumbnail designer & video editor who turns content into clicks. I design visuals that stop the scroll and craft edits that keep audiences hooked from first frame to last."}
            </p>
            <p className="about-text reveal">
              {bio2 ||
                "With 3+ years in the game, I've worked with creators across YouTube, Instagram, and beyond — delivering high-impact thumbnails, cinematic edits, and motion graphics that elevate every channel I touch."}
            </p>
